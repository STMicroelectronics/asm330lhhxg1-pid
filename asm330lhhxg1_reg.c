                                      ...
                                      asm330lhhxg1_odr_xl_t val)
{
  ...
  asm330lhhxg1_emb_fsm_enable_t fsm_enable = {0};
  asm330lhhxg1_fsm_odr_t fsm_odr = ASM330LHHXG1_ODR_FSM_12Hz5;
  uint8_t mlc_enable = 0;
  asm330lhhxg1_mlc_odr_t mlc_odr = ASM330LHHXG1_ODR_PRGS_12Hz5;
  asm330lhhxg1_ctrl1_xl_t ctrl1_xl = {0};
  int32_t ret = 0;
...
{
  asm330lhhxg1_ctrl2_g_t ctrl2_g = {0};
  int32_t ret = 0;
...
int32_t asm330lhhxg1_block_data_update_set(const stmdev_ctx_t *ctx,
                                           uint8_t val)
{
  asm330lhhxg1_ctrl3_c_t ctrl3_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_ctrl6_c_t ctrl6_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_ctrl7_g_t ctrl7_g = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_xl_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                            uint8_t *val)
{
  asm330lhhxg1_status_reg_t status_reg = {0};
  int32_t ret = {0};
                                         ...
                                         int8_t *val)
{
  ...
  ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_X_OFS_USR, (uint8_t *)val, 1);
                                         ...
                                         int8_t *val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_X_OFS_USR, (uint8_t *)val, 1);
                                         ...
                                         int8_t *val)
{
  ...
  ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_Y_OFS_USR, (uint8_t *)val, 1);
                                         ...
                                         int8_t *val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_Y_OFS_USR, (uint8_t *)val, 1);
                                         ...
                                         int8_t *val)
{
  ...
  ret = asm330lhhxg1_write_reg(ctx, ASM330LHHXG1_Z_OFS_USR, (uint8_t *)val, 1);
                                         ...
                                         int8_t *val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_Z_OFS_USR, (uint8_t *)val, 1);
...
{
  asm330lhhxg1_ctrl10_c_t ctrl10_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_ctrl5_c_t ctrl5_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_internal_freq_fine_t internal_freq_fine = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_func_cfg_access_t func_cfg_access = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_page_rw_t page_rw = {0};
  asm330lhhxg1_page_sel_t page_sel = {0};
  asm330lhhxg1_page_address_t page_address = {0};
  uint8_t msb = {0};
  uint8_t lsb = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
{
  asm330lhhxg1_counter_bdr_reg1_t counter_bdr_reg1 = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_device_id_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  ...
  ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_WHO_AM_I, val, 1);
...
{
  asm330lhhxg1_ctrl4_c_t ctrl4_c = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_ctrl8_xl_t ctrl8_xl = {0};
  int32_t ret = {0};
                                           ...
                                           asm330lhhxg1_hp_slope_xl_en_t *val)
{
  ...
  else
  {
    ...
    {
      case 0x00:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_4 : ASM330LHHXG1_SLOPE_ODR_DIV_4;
        break;

      case 0x01:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_10 : ASM330LHHXG1_HP_ODR_DIV_10;
        break;

      case 0x02:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_20 : ASM330LHHXG1_HP_ODR_DIV_20;
        break;

      case 0x03:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_45 : ASM330LHHXG1_HP_ODR_DIV_45;
        break;

      case 0x04:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_100 : ASM330LHHXG1_HP_ODR_DIV_100;
        break;

      case 0x05:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_200 : ASM330LHHXG1_HP_ODR_DIV_200;
        break;

      case 0x06:
        *val = is_low_pass == 1u ? ASM330LHHXG1_LP_ODR_DIV_400 : ASM330LHHXG1_HP_ODR_DIV_400;
        break;
...
{
  asm330lhhxg1_int_cfg0_t int_cfg0 = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_pin_ctrl_t pin_ctrl = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_i3c_bus_avb_t i3c_bus_avb = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_ctrl9_xl_t ctrl9_xl = {0};
  asm330lhhxg1_i3c_bus_avb_t i3c_bus_avb = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_pin_int2_route_t pin_int2_route = {0};
  asm330lhhxg1_int_cfg1_t int_cfg1 = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_pin_int1_route_t pin_int1_route = {0};
  asm330lhhxg1_int_cfg1_t int_cfg1 = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_wake_up_dur_t wake_up_dur = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_wake_up_ths_t wake_up_ths = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_ths_6d_t ths_6d = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_free_fall_t free_fall = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_fifo_ctrl1_t fifo_ctrl1 = {0};
  asm330lhhxg1_fifo_ctrl2_t fifo_ctrl2 = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_fifo_ctrl3_t fifo_ctrl3 = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_fifo_ctrl4_t fifo_ctrl4 = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_batch_counter_threshold_set(const stmdev_ctx_t *ctx,
                                                 uint16_t val)
{
  asm330lhhxg1_counter_bdr_reg2_t counter_bdr_reg1 = {0};
  asm330lhhxg1_counter_bdr_reg2_t counter_bdr_reg2 = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_fifo_data_out_tag_t fifo_data_out_tag = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_sh_batch_slave_0_set(const stmdev_ctx_t *ctx,
                                          uint8_t val)
{
  asm330lhhxg1_slv0_config_t slv0_config = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_sh_batch_slave_1_set(const stmdev_ctx_t *ctx,
                                          uint8_t val)
{
  asm330lhhxg1_slv1_config_t slv1_config = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_sh_batch_slave_2_set(const stmdev_ctx_t *ctx,
                                          uint8_t val)
{
  asm330lhhxg1_slv2_config_t slv2_config = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_sh_batch_slave_3_set(const stmdev_ctx_t *ctx,
                                          uint8_t val)
{
  asm330lhhxg1_slv3_config_t slv3_config = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_mag_offset_set(const stmdev_ctx_t *ctx, const int16_t *val)
{
  uint8_t buff[6] = {0};
  int32_t ret = {0};
  uint8_t i = {0};
...
{
  asm330lhhxg1_mag_cfg_a_t mag_cfg_a = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_mag_cfg_b_t mag_cfg_b = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_fsm_status_a_mainpage_t status_a = {0};
  asm330lhhxg1_fsm_status_b_mainpage_t status_b = {0};
  int32_t ret = {0};
...
int32_t asm330lhhxg1_long_cnt_flag_data_ready_get(const stmdev_ctx_t *ctx,
                                                  uint8_t *val)
{
  asm330lhhxg1_emb_func_status_t emb_func_status = {0};
  int32_t ret = {0};
...
{
  int32_t ret = {0};
  asm330lhhxg1_emb_func_en_b_t emb_func_en_b = {0};
...
{
  asm330lhhxg1_fsm_long_counter_clear_t fsm_long_counter_clear = {0};
  int32_t ret = {0};
                                 ...
                                 uint8_t *val)
{
  ...
  if (ret == 0)
  {
    ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_FSM_OUTS1, val, 16);
  }
...
{
  asm330lhhxg1_emb_func_odr_cfg_b_t emb_func_odr_cfg_b = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_emb_func_init_b_t emb_func_init_b = {0};
  int32_t ret = {0};
                                                ...
                                                uint8_t *val)
{
  ...
  ret = asm330lhhxg1_ln_pg_write_byte(ctx, ASM330LHHXG1_FSM_PROGRAMS, val);
                                                ...
                                                uint8_t *val)
{
  ...
  ret = asm330lhhxg1_ln_pg_read_byte(ctx, ASM330LHHXG1_FSM_PROGRAMS, val);
...
{
  asm330lhhxg1_emb_func_en_b_t reg = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_emb_func_odr_cfg_c_t reg = {0};
  int32_t ret = {0};
...
/**
  ...
  *
  */
int32_t asm330lhhxg1_mlc_out_get(const stmdev_ctx_t *ctx, uint8_t *val)
{
  int32_t ret = {0};
  ...
  if (ret == 0)
  {
    ret = asm330lhhxg1_read_reg(ctx, ASM330LHHXG1_MLC0_SRC, val, 8);
  }
...
{
  asm330lhhxg1_slv0_add_t slv0_add = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_slv1_config_t slv1_config = {0};
  asm330lhhxg1_slv1_add_t slv1_add = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_slv2_config_t slv2_config = {0};
  asm330lhhxg1_slv2_add_t slv2_add = {0};
  int32_t ret = {0};
...
{
  asm330lhhxg1_slv3_config_t slv3_config = {0};
  asm330lhhxg1_slv3_add_t slv3_add = {0};
  int32_t ret = {0};
